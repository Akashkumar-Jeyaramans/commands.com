...
var (
	filter_Command_Get_0 = &utilities.DoubleArray{Encoding: map[string]int{"oid": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
func request_Command_Get_0(ctx context.Context, marshaler runtime.Marshaler, client CommandClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	protoReq.Oid, err = runtime.StringSlice(val, ",")
	if err != nil {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_Command_Get_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func RegisterCommandHandlerServer(ctx context.Context, mux *runtime.ServeMux, server CommandServer) error {
	...
	mux.Handle("POST", pattern_Command_Get_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/commands.Command/Get", runtime.WithHTTPPathPattern("/v1/operations/get/{oid}"))
		if err != nil {
...
func RegisterCommandHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CommandClient) error {
	...
	mux.Handle("POST", pattern_Command_Get_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/commands.Command/Get", runtime.WithHTTPPathPattern("/v1/operations/get/{oid}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_Command_Get_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"v1", "operations", "get", "oid"}, ""))
)
